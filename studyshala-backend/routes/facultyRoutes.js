...
// Sub-folders
router.post('/folders/:id/subfolders',                        facultyController.createSubFolder);
router.delete('/folders/:id/subfolders/:sfId',                facultyController.deleteSubFolder);
router.post('/folders/:id/subfolders/:sfId/files', upload.array('files', 20), facultyController.uploadFiles);
router.delete('/folders/:id/subfolders/:sfId/files/:fileId',  facultyController.deleteSubFolderFile);

// Faculty message
router.patch('/folders/:id/message',                          facultyController.updateMessage);
