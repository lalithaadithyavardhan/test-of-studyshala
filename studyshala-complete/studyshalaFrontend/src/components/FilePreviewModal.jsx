...
import { MdClose, MdDownload, MdFilePresent } from 'react-icons/md';
    ...
    if (!file.driveFileId) {
      return (
        <div className="fpv-unavail">
          <span className="fpv-unavail-icon"><MdFilePresent /></span>
    ...
    >
      <div className="fpv-modal">
        <div className="fpv-header">
          ...
          <button className="fpv-close" onClick={onClose} title="Close (Esc)"><MdClose /></button>
        </div>
