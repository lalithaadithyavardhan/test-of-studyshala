...
export default function StarredScreen() {
  ...
  const filtered = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      list = list.filter((f) => f.fileName?.toLowerCase().includes(q) || f.subjectName?.toLowerCase().includes(q));
    }
          ...
          ListEmptyComponent={
            <View style={s.emptyCard}>
              ...
              <Text style={s.emptyTitle}>
                {searchQuery ? 'No results found' : 'No starred files yet'}
              </Text>
